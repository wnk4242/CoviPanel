...
document.addEventListener("mouseup", function() {
    isDragging = false;
        ...
        startBtn.onclick = function() {
            ...
            let currentCount = parseInt(GM_getValue("sessionCount", "0"), 10);
            if (isNaN(currentCount) || currentCount < 1) currentCount = 0;
            const newCount = currentCount + 1;
            GM_setValue("sessionCount", newCount);
...
`);
    ...
    if (confirm('Reset your lifetime progress?')) {
        ...
        GM_setValue("sessionCount", "0");// 🔁 Reset session count
