...
<div style='margin-top: 14px; margin-bottom: 14px;'>
    <div style='display: flex; gap: 6px;'>
        <input id='keywordInput' placeholder='Enter keywords' style='flex: 1; padding: 4px; font-size: 13px;'>
...
addKeywordsBtn.onclick = () => {
    ...
    GM_setValue('keywordTags', JSON.stringify(keywords));  // ✅ store tag list persistently
