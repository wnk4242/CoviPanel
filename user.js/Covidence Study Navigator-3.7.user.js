...
(function() {
    ...
    function createPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id="topRightIcons" style="position: absolute; top: 8px; right: 8px; display: none; gap: 6px; flex-direction: row;">
              <button id="exportBtn" title="Export decisions" style="background:none; border:none; cursor:pointer; font-size:20px;" aria-label="Export decisions">🖫</button>
              <button id="resetBtn" title="Reset" style="background:none; border:none; cursor:pointer; font-size:20px;" aria-label="Reset">⟳</button>
            </div>
            ...
            <div id='studyControls' style='display:none; margin-top:15px;'>
              ...
              <div style='margin-top: 14px; margin-bottom: 14px;'>
                <div style='display: flex; gap: 6px;'>
                  ...
                  <button id='addKeywordsBtn' style='padding: 4px 8px; background-color: #007BFF; color: white; border: none; border-radius: 4px; font-size: 13px; font-weight: bold;'>Add</button>
                </div>
        ...
        function updatePanelDecisionButtonsState() {
            ...
            const alreadyVoted = document.querySelector("button.vote-option.selected"); // native Covidence buttons
        ...
        function simulateDecision(value) {
            ...
            if (index < studies.length - 1) {
                ...
                const allFinished = studies.every(id =>
                                                  decisions[id] && decisions[id] !== "Skipped"
                                                 );
                ...
                if (allFinished) {
                    ...
                    // ✅ Redirect to Covidence vote_required_from
                    setTimeout(() => {
                    ...
                    }, 100); // give time for CSV download and UI update
                }
            }
