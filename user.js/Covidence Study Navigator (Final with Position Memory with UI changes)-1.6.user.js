// ==UserScript==
// @name         Covidence Study Navigator (Final with Position Memory)
// @namespace    http://tampermonkey.net/
// @version      1.6
// @description  Draggable Covidence panel with saved position, CSV export, progress tracking, and decision logging.
// @match        *://*.covidence.org/*
// @grant        GM_setValue
// @grant        GM_getValue
// ==/UserScript==
    ...
    function createPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id='studyControls' style='display:none; margin-top:10px;'>
                ...
                <button id='exportBtn' style='margin-top:5px;'>📥 Export decisions to .csv</button>
            </div>
        `;
        document.body.appendChild(panel);

        // Dragging logic with saved position
            ...
            buttons.forEach(btn => {
                ...
                if (["Yes", "No", "Maybe"].includes(value) && !btn.dataset.csvAttached) {
                    ...
                    btn.addEventListener("click", () => {
                        ...
                        if (currentDisplay) currentDisplay.textContent = "#" + currentID + " ✔ Done";
                    });
                }
            });
        }
