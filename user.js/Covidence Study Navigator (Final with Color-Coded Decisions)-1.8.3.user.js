        ...
        panel.innerHTML = `
            ...
            <div id='studyControls' style='display:none; margin-top:15px;'>
                ...
                <div style="margin-bottom: 20px; display: flex; flex-direction: column; gap: 8px; align-items: center;">
                    <button id='resetBtn' style='background-color: #001f3f; color: white; width: 80%; padding: 8px 0; border-radius: 6px;'>🔄 Reset</button>
                    <button id='backBtn' style='background-color: #001f3f; color: white; width: 80%; padding: 8px 0; border-radius: 6px;'>⬅️ Back</button>
                    <button id='nextBtn' style='background-color: #001f3f; color: white; width: 80%; padding: 8px 0; border-radius: 6px;'>➡️ Next</button>
                    <button id='pressEnterBtn' style='background-color: #001f3f; color: white; width: 80%; padding: 8px 0; border-radius: 6px;'>⏎ Enter</button>
                </div>
                <button id='exportBtn' style='width: 100%;'>📥 Export decisions to .csv</button>
            </div>
        `;
