...
// @version      1.9.6
// @description  Draggable Covidence panel with saved position, decision logging, CSV export, color-coded decision display, in-panel decision buttons, foldable summary section, and correct final decision submission without triggering error.
// @match        *://*.covidence.org/*
// @grant        GM_setValue
// @grant        GM_getValue
// ==/UserScript==
    ...
    function createPanel() {
        ...
        function updateSummary() {
            ...
            summaryList.innerHTML =
                `<strong style="color:orange;">Maybe:</strong> ${maybeList.join(', ')}<br>
                 <strong style="color:green;">Yes:</strong> ${yesList.join(', ')}<br>
                 <strong style="color:red;">No:</strong> ${noList.join(', ')}`;
        }
