...
(function () {
    ...
    function createPanel() {
        ...
        function makeClickableList(ids, color) {
            return ids.map(id => {
                return `<a href="#" data-jump-id="${id}" style="color:${color}; text-decoration:underline;">${id}</a>`;
            }).join(', ');
        }
        ...
        function updateSummary() {
            ...
            summaryList.querySelectorAll('a[data-jump-id]').forEach(a => {
                a.addEventListener('click', (e) => {
                    ...
                    document.querySelector('#covidence-panel').dataset.jumpTo = jumpID;
                });
            });
        }
        ...
        function simulateDecision(value) {
            ...
            if (index < studies.length - 1) {
                ...
                setTimeout(() => {
                    ...
                    const target = `${window.location.origin}/reviews/${reviewId}/review_studies/screen?filter=vote_required_from`;
