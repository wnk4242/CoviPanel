...
// @version      1.9.2
// @description  Draggable Covidence panel with saved position, decision logging, CSV export, color-coded decision display, and in-panel decision buttons. Shows Maybe/Yes/No papers at bottom.
// @match        *://*.covidence.org/*
// @grant        GM_setValue
// @grant        GM_getValue
// ==/UserScript==
    ...
    function createPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id='studyControls' style='display:none; margin-top:15px;'>
                ...
                <div id='summaryList' style='margin-top: 10px; font-size: 12px; line-height: 1.4; max-height: 150px; overflow-y: auto;'></div>
            </div>
        `;
