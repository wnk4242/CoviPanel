    ...
    function createPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id='studyControls' style='display:none; margin-top:15px;'>
                ...
                <div style="margin-bottom: 30px; display: flex; flex-direction: column; gap: 8px; align-items: center;">
                    ...
                    <button id='pressEnterBtn' style='background-color: #001f3f; color: white; width: 80%; padding: 8px 0; border-radius: 6px; font-weight: bold;'>Enter</button>
                </div>
