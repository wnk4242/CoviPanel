...
function updateLifetimeProgressUI() {
    ...
    container.innerHTML = `
        ...
        <div style="text-align:center; font-size:13px; font-weight:600; margin-bottom:4px;">${currentTitle}</div>
        ...
        <div id="lifetimeProgressText" style="font-size: 12px; margin-bottom: 6px; text-align:center;">${count} / ${nextThreshold} studies</div>
    `;
