...
(function() {
    ...
    function createPanel() {
        ...
        startBtn.onclick = function() {
            ...
            const cleanInput = rawInput.replace(/\n|\r/g, ',');  // Replace line breaks with commas
        ...
        panel.querySelector("#studyControls").appendChild(exportBtn);
        exportBtn.onclick = function() {
            const csvContent = "data:text/csv;charset=utf-8,Study ID,Decision\n" + Object.entries(decisions).map(([id, dec]) => `${id},${dec}`).join("\n");
